...
<header>
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/employees" target="_blank">Employees</a>
            </li>
...
<div class="further">
    ...
    <table class="table table-striped">
        ...
        <?php foreach ($employees as $employee): ?>
            <tr>
                <td><?= esc($employee['title'])?></td>
                <td><?= esc($employee['age'])?></td>
                <td><?= esc($employee['company'])?></td>
                <td>
                    <a href="#" class="btn btn-info btn-sm btn-edit" data-id="<?= $employee['employee_id'];?>" data-title="<?= $employee['title'];?>" data-age="<?= $employee['age'];?>" data-company="<?= $employee['company'];?>">Edit</a>
                    <a href="#" class="btn btn-danger btn-sm btn-delete" data-employee_id="<?= $employee['employee_id'];?>">Delete</a>
                </td>
            </tr>
        <?php endforeach ?>
        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Age</label>
                        <input type="text" class="form-control" name="age" placeholder="Employee age">
                    </div>

                    <div class="form-group">
                        <label>Company</label>
                        <input type="text" class="form-control" name="company" placeholder="Employee company">
                    </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <input type="hidden" name="employee_id" class="productID">
...
<script>
    $(document).ready(function(){
        ...
        $('.btn-edit').on('click',function(){
            ...
            const price = $(this).data('age');
            const category = $(this).data('company');
